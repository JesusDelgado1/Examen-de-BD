...
ALTER TABLE Tipo_transporte ADD CONSTRAINT tipo_transporte_id_descuento_por_transporte FOREIGN KEY (id_descuento_por_transporte) References Descuento_por_transporte (id_descuento_por_transporte);
